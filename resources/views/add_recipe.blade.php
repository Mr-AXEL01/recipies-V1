    ...
    <div class="mx-auto w-full max-w-[550px] bg-white">
        <form class="py-6 px-9" action="/create" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="ingredients" id="ingredients" placeholder="ingredients" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="text" name="recipe" id="recipe" placeholder="titre" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            </div>
